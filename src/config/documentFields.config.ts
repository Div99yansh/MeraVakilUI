...
export const DOCUMENT_SPECIFIC_FIELDS: Record<DocumentType, FieldConfig[]> = {
  ...
  notice: [
    ...
    },
    {
      ...
      validation: z
        .string()
        .min(50, "Please provide detailed issue description"),
    },
    {
  ...
  affidavit: [
    ...
    },
    {
      ...
      validation: z
        .string()
        .min(100, "Please provide detailed facts (min 100 characters)"),
    },
    {
      name: "annexures",
...
export function getFieldsForDocumentType(
  ...
  const normalizedDocType = normalizeDocType(docType as string);
  return [
    ...BASE_FIELDS,
    ...(DOCUMENT_SPECIFIC_FIELDS[normalizedDocType] || []),
  ];
}
